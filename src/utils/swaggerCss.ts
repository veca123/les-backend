...
.swagger-ui .b--white { border-color: #242424; }
...
.swagger-ui .bg-white, .swagger-ui .hover-bg-white:focus, .swagger-ui .hover-bg-white:hover { background-color: #242424; }
